...
public class SongListAdapter extends BaseAdapter {
    ...
    class ViewHolderProfile {
        @Bind(R.id.tv_profile) TextView tvProfile;
    ...
    class ViewHolderMusicList {
        ...
        @Bind(R.id.tv_music_1) TextView tvMusic1;
        @Bind(R.id.tv_music_2) TextView tvMusic2;
        @Bind(R.id.tv_music_3) TextView tvMusic3;
